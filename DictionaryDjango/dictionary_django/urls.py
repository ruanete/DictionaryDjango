...
urlpatterns += (
    ...
    path('dictionary_django/term/remove/<int:pk>/', views.termRemoveView.as_view(success_url = "/dictionary_django/dictionary_django/term/"), name='dictionary_django_term_remove'),
...
urlpatterns += (
    ...
    path('dictionary_django/definition/remove/<int:pk>/', views.definitionRemoveView.as_view(success_url = "/dictionary_django/dictionary_django/definition/"), name='dictionary_django_definition_remove'),
